 ...
 *
 */
public class Autonomous3Tote2RCArm extends CommandGroup {
    
    public  Autonomous3Tote2RCArm() {
    	// The Plan:
    	// 1) Start with robot surrounding the rightmost container, facing right from DS perspective
    	// 2) Lift container
    	...
    	// Get everyone else's totes and one of the remaining containers
    	...
    	// If all goes well, we now have an RC and a 3-tote stack, with another RC on the arms.
    	// Head for the Auto Zone
		// 8) Turn 90'
