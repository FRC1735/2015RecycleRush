...
public class CollectorDeployer extends PIDSubsystem {
    ...
    public void deployMove(double magnitudeDirection, boolean ignoreLimits) {
    	//if we are currently at a limit, don't do anything... unless we called this from manual override mode and want to explicitly ignore the limits...
//    	if (!ignoreLimits && ((magnitudeDirection > 0) && reachedUpLimit()) ||
