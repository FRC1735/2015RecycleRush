...
import org.usfirst.frc1735.RecycleRush2015.commands.DeployDownSetpointGo;
import org.usfirst.frc1735.RecycleRush2015.commands.DeployUpSetpointGo;
...
public class OI {
    ...
    public JoystickButton liftTo2ToteHeight;
    public JoystickButton liftContainerTo1ToteHeight;
    public JoystickButton dropStack;
    public JoystickButton runActiveLifter;
    public JoystickButton disableActiveLifter;
    public JoystickButton pIDDeployUp;
    public JoystickButton pIDDeployDown;
    public JoystickButton manualDeployUp;
    public JoystickButton manualDeployDown;
    ...
    public OI() {
        ...
        manualDeployDown = new JoystickButton(accessoryJoystick, 10);
        manualDeployDown.whileHeld(new CollectDeployDown());
        manualDeployUp = new JoystickButton(accessoryJoystick, 11);
        manualDeployUp.whileHeld(new CollectDeployUp());
        pIDDeployDown = new JoystickButton(accessoryJoystick, 7);
        pIDDeployDown.whenPressed(new DeployDownSetpointGo());
        pIDDeployUp = new JoystickButton(accessoryJoystick, 6);
        pIDDeployUp.whenPressed(new DeployUpSetpointGo());
        disableActiveLifter = new JoystickButton(accessoryJoystick, 9);
        disableActiveLifter.whenPressed(new LifterActiveDisable());
        runActiveLifter = new JoystickButton(accessoryJoystick, 8);
        runActiveLifter.whenPressed(new LifterActiveMode());
        dropStack = new JoystickButton(accessoryJoystick, 2);
        dropStack.whenPressed(new LifterDropStack());
        liftContainerTo1ToteHeight = new JoystickButton(accessoryJoystick, 5);
        liftContainerTo1ToteHeight.whenPressed(new LifterContainerSetpointGo());
        liftTo2ToteHeight = new JoystickButton(accessoryJoystick, 3);
        liftTo2ToteHeight.whenPressed(new Lifter2ToteSetpointGo());
        liftTo1ToteHeight = new JoystickButton(accessoryJoystick, 4);
        ...
        SmartDashboard.putData("Deploy Up Setpoint Go", new DeployUpSetpointGo());

        SmartDashboard.putData("Deploy Down Setpoint Go", new DeployDownSetpointGo());

        SmartDashboard.putData("Turn Downfield", new TurnDownfield());
